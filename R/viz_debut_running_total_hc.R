...
viz_debut_running_total_hc <- function(countries, start = NULL, end = NULL,
  ...
  hc <- highcharter::highchart() |>
    ...
    highcharter::hc_subtitle(
      text = sprintf("First debut: %s o Last debut: %s", first_debut, last_debut)
    ) |>
    ...
    highcharter::hc_credits(
      enabled = TRUE,
      text = paste0("Data retrieved ", scrape_date, " o Brackets show players with unknown debut years"),
      href = NULL
    )
